...
%Add inclusion
epi{1}(125:150,1:20)= c_eps_0*11.3;
...
%bc structure used to setup boundary conditions and sources
bc{1}.NumS = 1;
%bc{1}.s(1) setting up planewave siourcw
...
%bc{1}.xm/xp/ym/yp sets up horizontal and verticle boundary conditions
bc{1}.xm.type = 'a';
%When type changed to e we got an absorbing BC
bc{1}.xp.type = 'a';
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
